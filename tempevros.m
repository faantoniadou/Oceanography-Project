...
plot(year,yearlyavg_sst,'b--x')
hold on
ylabel('Mean Sea Surface Temperature / °C');
xlabel('Date');
xticks([start_year : calyears(1) : (end_year)]);
xtickangle(45);
title('Annual Mean Sea Surface Temperature in the river Evros estuary region');
...
polynomial2 = polyfit(datenum(w),yearlyavg_sst, 3);
